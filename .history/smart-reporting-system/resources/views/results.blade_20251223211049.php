...
<head>
    ...
    <style>
        ...
        /* Metrics */
        .metric-value { font-size: 2rem; font-weight: 800; background: linear-gradient(to right, #fff, #083873ff); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
