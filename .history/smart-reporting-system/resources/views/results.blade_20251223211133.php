...
<head>
    ...
    <style>
        ...
        /* Metrics */
        .metric-value { font-size: 2rem; font-weight: 800; background: linear-gradient(to right, #2c2765ff, #01244fff); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
