...
<head>
    ...
    <style>
        ...
        /* Metrics */
        .metric-value { font-size: 2rem; font-weight: 800; background: linear-gradient(to right, #59566eff, #260d72ff); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
