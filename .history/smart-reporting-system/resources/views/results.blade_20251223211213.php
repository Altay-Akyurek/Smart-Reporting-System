...
<head>
    ...
    <style>
        ...
        /* Metrics */
        .metric-value { font-size: 2rem; font-weight: 800; background: linear-gradient(to right, #403c63ff, #929394ff); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
